      ...
      <VStack spacing={8} align="stretch">
        ...
        <Box mt={8}>
          ...
          <VStack spacing={4} align="stretch">
            <SectionLink number={1} title="Introduction to MCP" />
            <SectionLink number={2} title="TypeScript Fundamentals for MCP" />
            <SectionLink number={3} title="MCP Core Concepts" />
            <SectionLink
              number={4}
            ...
            />
            <SectionLink number={6} title="Advanced MCP Features" />
            <SectionLink number={7} title="Real-world Applications" />
            <SectionLink
              number={8}
            ...
            />
            <SectionLink number={10} title="Final Project" />
          </VStack>
        </Box>
        ...
        >
          ...
          <Text fontSize="lg" mb={6}>
            Start your journey to becoming an MCP expert today!
          </Text>
          <Button as={RouterLink} to="/section/1" colorScheme="blue" size="lg">
            Begin Course
          </Button>
